...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var doQuizButtonRounded: UIButton!
    ...
    override func viewDidLoad() {
      ...
      doGoalsButtonRounded.layer.borderColor = CGColor(red: 233 / 255, green: 243 / 255, blue: 235 / 255, alpha: 1)
        ...
        doQuizButtonRounded.layer.cornerRadius = 20
      doQuizButtonRounded.layer.borderWidth = 10
      doQuizButtonRounded.layer.borderColor = CGColor(red: 233 / 255, green: 243 / 255, blue: 235 / 255, alpha: 1)
       }
    }
